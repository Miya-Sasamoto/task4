...
public class DBAccess {
    ...
    private static final String JDBC_CONNECTION = "jdbc:postgresql://localhost:5432/test_db";
    /** ・ユーザー名 */
    // 問② データベースのユーザー名を定数にしなさい。
    private static final String USER = "miya";
    /** ・パスワード */
    // 問③ データベースのパスワードを定数にしなさい。
    private static final String PASS = "Miya122538";
